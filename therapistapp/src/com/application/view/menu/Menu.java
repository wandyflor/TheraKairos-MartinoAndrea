package com.application.view.menu;

import com.application.view.mode.LightDarkMode;
...
import com.application.view.mode.ToolBarAccentColor;
...
public class Menu extends JPanel {
    ...
    private void init() {
        ...
        header.setIcon(new ImageIcon(getClass().getResource("/com/application/view/resources/png/logo.png")));
